...
public class Organization {
  ...
  public Organization id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Organization settings(@jakarta.annotation.Nullable Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }

  public Organization putSettingsItem(String key, Object settingsItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, id, settings);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "id", "settings"));
