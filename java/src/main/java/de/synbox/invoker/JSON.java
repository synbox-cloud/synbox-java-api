...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new de.synbox.model.Organization.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new de.synbox.model.V1FileKeySelector.CustomTypeAdapterFactory());
